...
- Name: rbac.spec.ts >> Role-Based Access Control >> Direct URL access to restricted pages should redirect or show 403
- Location: tests/e2e/rbac.spec.ts:34:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/dashboard/settings/staff
Call log:
  - navigating to "http://localhost:3001/dashboard/settings/staff", waiting until "load"
