...
DROP COLUMN IF EXISTS "workspaceId",
ADD COLUMN IF NOT EXISTS "tenantId" TEXT NOT NULL DEFAULT 'system';

-- AlterTable
ALTER TABLE IF EXISTS "Message" DROP COLUMN IF EXISTS "tokenId",
ADD COLUMN IF NOT EXISTS "conversationId" TEXT,
ADD COLUMN IF NOT EXISTS "customerPhone" TEXT NOT NULL DEFAULT 'unknown',
...
ADD COLUMN IF NOT EXISTS "ownerId" TEXT NOT NULL DEFAULT 'system',
ADD COLUMN IF NOT EXISTS "tenantId" TEXT NOT NULL DEFAULT 'system';
